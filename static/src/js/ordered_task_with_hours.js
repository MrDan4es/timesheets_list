/** @odoo-module alias=timesheets_list.ordered_task_with_hours **/

import field_registry from 'web.field_registry';
import { FieldMany2One } from 'web.relational_fields';

const OrderedTaskWithHours = FieldMany2One.extend({
    /**
     * @override
     */
    init: function () {
...
field_registry.add('ordered_task_with_hours', OrderedTaskWithHours);

export default OrderedTaskWithHours;
